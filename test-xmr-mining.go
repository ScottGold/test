...
func main() {
	...
	//xmr_wallet_cli := "C:/dev/bitcoin-0.18/monero-v0.14/build/release/bin/monero-wallet-cli.exe"
	...
	log.Println("start one four loop")
	for {
